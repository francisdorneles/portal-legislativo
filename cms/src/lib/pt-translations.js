export const ptTranslations = {
    ...
    dashboard: {
        ...
        discardMessage: 'Você tem alterações não salvas no layout do seu painel. Tem certeza de que deseja descartá-las?',
        discardTitle: 'Descartar alterações?',
        editDashboard: 'Editar Painel',
        editingDashboard: 'Edição do Painel',
        noItems: 'Não existem widgets no seu painel. Você pode adicioná-los a partir do menu "Painel", localizado na barra superior.',
    ...
    general: {
        ...
        documentOutOfDate: 'Este documento foi recentemente atualizado por outro usuário. Sua visualização está desatualizada.',
        ...
        noResultsDescription: 'Ou nenhum existe ou nenhum corresponde aos filtros que você especificou acima.',
    ...
    version: {
        ...
        revertUnsuccessful: 'Reversão não bem-sucedida. Nenhuma versão publicada anteriormente encontrada.',
